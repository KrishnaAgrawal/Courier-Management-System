        ...
        <script>
            ...
            function getFeedbackData() {
                $(document).on("click", ".data-edit", function () {
                    ...
                    $.ajax({
                        url: 'code/u-ajaxRequest.php?action=get-feedback',
                        method: 'POST',
                        data: {feeddbackId: feeddbackId},
                        dataType: 'json',
                        success: function (data) {
                            $('#int_feedback_id').val(data.int_feedback_id);
                            $('.txt_name').val(data.txt_name);
                            $('.txt_number').val(data.txt_number);
                            $('.txt_email').val(data.txt_email);
                            $('.txt_feedback').val(data.txt_feedback);
             ...
             * get-booked-courier-data
             */
            function getFeedbackDataInView() {
             ...
             * get-booked-courier-data
             */
            function deleteFeedbackData(feedbackId) {
                var res = confirm("Are you sure to delete this item?");
                if(res){
                    window.location.href = "code/u-ajaxRequest.php?action=deleteFeedback&feedbackId="+feedbackId;
                }
            }
        ...
        <div class="container-fluid bg-light">
            ...
            <div class="container ">
                <div class="col-sm-12 my-4" id="user">
                    <div class="separator">
                        <h4 class="ask font-weight-bold fa-2x text-center">Feedback</h4>
                    </div>
                </div>
            </div>
            <?php
...
//                        echo '<pre>';print_r($pageLimit);
            ...
            $queryCount = "SELECT count(*) FROM tbl_feedback WHERE ysn_deleted=0";
...
//                        include_once './Utilities.php';
                        $query = "SELECT * FROM tbl_feedback WHERE ysn_deleted=0 LIMIT $startingIndex, $pageLimit";
//                        echo $query;exit;
...
//                                echo '<pre>';print_r($rows);exit;
                                ...
                                <tr class="table-body mark-row-<?= $rows['0'] ?>">
                                    ...
                                    <td class="txt_short_name-<?= $rows['0'] ?>" 
                                        id="cust_city-<?= $rows['0'] ?>"
                                        name="txt_city-<?= $rows['0'] ?>"><?= $rows['txt_feedback'] ?></td>
                                    <td <?= $adminType ?> >
                                        <a 
                                            class="text-dark data-view" 
                                            onclick="getFeedbackDataInView()"
                                            id='<?= $rows['int_feedback_id'] ?>'
                                            style="cursor: pointer;"
                                            title="View">
                                        ...
                                        &nbsp;
                                        <a onclick="deleteFeedbackData(<?= $rows['0'] ?>)" 
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Give Feedback</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="code/u-ajaxRequest.php?action=giveFeedback" 
                      method="post" 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="txt_email" class="col-form-label font-weight-bold">Feedback<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                                <textarea class="form-control" id="" required="" name="txt_feedback" rows="3"></textarea>
...
<div class="modal fade" id="updateFeedback" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="code/u-ajaxRequest.php?action=updateFeedback" 
                      method="post" 
                      id="book-courier-package-form"
                      enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <input type="hidden" class="form-control" id="int_feedback_id" name="int_feedback_id" 
                                    aria-describedby="int_feedback_id" required="true">
                            <label for="txt_name" class="col-form-label font-weight-bold">Name<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="txt_email" class="col-form-label font-weight-bold">Feedback<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                                <textarea class="form-control txt_feedback" id="txt_feedback" 
                                          name="txt_feedback" rows="3" required=""></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <form action="code/u-ajaxRequest.php?action=viewCourierPackage" 
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="txt_email" class="col-form-label font-weight-bold">Feedback<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                                <textarea class="form-control txt_feedback" id="feedbackView" readonly="" 
                                          name="txt_feedback" rows="3"></textarea>
