        ...
        <div class="row top-bar">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 top-menu">
                <ul class="float-right navbar-right mt-2">
                    <li class="line-ht style"><a href="u-my-account.php" class="a-hover"><i class="fa fa-user"></i> <?= $_SESSION['name'] ?></a></li>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item menu">
                        <a class="nav-link" aria-disabled="true" href="u-courier-package.php">Courier Packages <span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item menu">
                        <a class="nav-link" aria-disabled="true" href="u-feedback.php">Feedbacks <span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item menu">
                        <a class="nav-link" aria-disabled="true" href="u-complaint.php">Complaints <span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item menu">
                        <a class="nav-link" aria-disabled="true" href="u-review.php">Reviews <span class="sr-only"></span></a>
                    </li>
...
<!--                    <li class="nav-item dropdown menu">
                    ...
                    <li class="nav-item dropdown menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="u-my-account.php">My Account</a>
                            <a class="dropdown-item" href="u-change-password.php">Change Password</a>
