        ...
        <script>
            ...
            function getReviewData() {
                $(document).on("click", ".data-edit", function () {
                    ...
                    $.ajax({
                        url: 'code/u-ajaxRequest.php?action=get-review',
                        method: 'POST',
            ...
            function deleteReviewData(reviewId) {
                ...
                if(res){
                    window.location.href = "code/u-ajaxRequest.php?action=deleteReview&reviewId="+reviewId;
                }
            }
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Give Review</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="code/u-ajaxRequest.php?action=giveReview" 
                      method="post" 
                      id="book-courier-package-form"
                      enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <label for="txt_name" class="col-form-label font-weight-bold">
                                Name<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                        ...
                        <div class="form-row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="mt-1">
                                <i class="far fa-star fa-2x " id="star1" onclick="getStar(1)" value="1"></i>
                                <i class="far fa-star fa-2x " id="star2" onclick="getStar(2)" value="2"></i>
                                <i class="far fa-star fa-2x " id="star3" onclick="getStar(3)" value="3"></i>
                                <i class="far fa-star fa-2x " id="star4" onclick="getStar(4)" value="4"></i>
                                <i class="far fa-star fa-2x " id="star5" onclick="getStar(5)" value="5"></i>
                                <input type="hidden" required="" name="tinyint_review" class="form-control tinyint_review"
                                       id="tinyint_review" />
                            </div>
                        </div>
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="txt_email" class="col-form-label font-weight-bold">
                                Review<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                                <textarea class="form-control" id="" required="" name="txt_review" rows="3"></textarea>
                    ...
                    <div class="form-group mt-3 mb-5">
                        ...
                        <input type="reset" class="btn btn-secondary mt-2 font-weight-bold" 
                               onclick="getStar(0)" value="Reset" />
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="updateReview" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="code/u-ajaxRequest.php?action=updateReview" 
                      method="post" 
                      id="book-courier-package-form"
                      enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            <label for="txt_email" class="col-form-label font-weight-bold">Email: </label>
                            <div class="">
                                <input type="email" class="form-control txt_email"
                                        onkeyup="validateRecipientEmail(this.value)" id="txt_email" name="txt_email" 
                                       aria-describedby="txt_email_help" placeholder="Email">
                        ...
                        <div class="form-row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="tinyint_review" class="col-form-label font-weight-bold mr-2">
                                Ratings<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="mt-1">
                                <i class="far fa-star fa-2x star1" id="star1Update" onclick="getStarUpdate(1)" value="1"></i>
                                <i class="far fa-star fa-2x star2" id="star2Update" onclick="getStarUpdate(2)" value="2"></i>
                                <i class="far fa-star fa-2x star3" id="star3Update" onclick="getStarUpdate(3)" value="3"></i>
                                <i class="far fa-star fa-2x star4" id="star4Update" onclick="getStarUpdate(4)" value="4"></i>
                                <i class="far fa-star fa-2x star5" id="star5Update" onclick="getStarUpdate(5)" value="5"></i>
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="">
                                <textarea class="form-control txt_review" id="txt_review" 
                                          name="txt_review" rows="3" required=""></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="tinyint_review" class="col-form-label font-weight-bold mr-2">
                                Ratings<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="mt-1">
                                <i class="far fa-star fa-2x star1" id="star1View" value="1"></i>
                                <i class="far fa-star fa-2x star2" id="star2View" value="2"></i>
                                <i class="far fa-star fa-2x star3" id="star3View" value="3"></i>
                                <i class="far fa-star fa-2x star4" id="star4View" value="4"></i>
                                <i class="far fa-star fa-2x star5" id="star5View" value="5"></i>
                            </div>
                        </div>
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="txt_email" class="col-form-label font-weight-bold">Review<sup class="text-danger font-weight-bold">*</sup>: </label>
                            <div class="">
                                <textarea class="form-control txt_review" id="reviewView" readonly="" 
                                          name="txt_review" rows="3"></textarea>
