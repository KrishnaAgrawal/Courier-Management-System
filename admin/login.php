        ...
        <div class="container-fluid" >
            <div class="row ">
                <div class="wrapper d-flex align-items-center justify-content-center flex-column">
                    ...
                    <?php } ?>
                    <div class="demo col-4 my-5">
                        <a href="<?=HOME?>" title="Go to <?=HOME?>" style="text-decoration: none;">
                            <h3 class="mt-5 mx-5 text-white text-center"> <?=COMPANY_NAME?> | Login </h3>
                        </a>
                        <br />
                        <div class="col">
                            <form action="verifyLogin" method="post" class="">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="email" name="username" maxlength="500" onkeyup="validateText(this.value)" placeholder="Enter your email/mobile*" required="true" />
                                ...
                                <div class="form-group">
                                    <input type="submit" class="form-control mb-5 text-secondary font-weight-bold col-3 float-right" id="submit" name="submit" value="Login" placeholder="Your Password*" required="true" />
                                </div>
                                <!--<sup class="text-danger font-weight-bold">* </sup><small class="text-danger"> Required</small>-->
                            </form>
                        </div>
                    </div>
                </div>
