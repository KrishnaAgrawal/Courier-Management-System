        ...
        <script>
            ...
            function getFeedbackData() {
                $(document).on("click", ".data-edit", function () {
                    ...
                    $.ajax({
                        url: 'code/ajaxRequests.php?action=get-feedback',
                        method: 'POST',
            ...
            function deleteFeedbackData(feedbackId) {
                ...
                if(res){
                    window.location.href = "code/ajaxRequests.php?action=deleteFeedback&feedbackId="+feedbackId;
                }
            }
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="code/ajaxRequests.php?action=updateFeedback" 
                      method="post" 
                        ...
                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <input type="number" class="form-control txt_number" id="txt_number" name="txt_number"
                                       aria-describedby="txt_number_help" placeholder="Number" readonly="" >
                            </div>
                        </div>
                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="">
                                <textarea class="form-control txt_feedback" id="txt_feedback" 
                                          name="txt_feedback" rows="3" required="" readonly="" ></textarea>
                            </div>
                        </div>
                    </div>
