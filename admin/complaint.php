        ...
        <script>
            ...
            function getComplaintData() {
                $(document).on("click", ".data-edit", function () {
                    ...
                    $.ajax({
                        url: 'code/ajaxRequests.php?action=get-complaint',
                        method: 'POST',
            ...
            function deleteComplaintData(complaintId) {
                ...
                if(res){
                    window.location.href = "code/ajaxRequests.php?action=deleteComplaint&complaintId="+complaintId;
                }
            }
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="code/ajaxRequests.php?action=updateComplaint" 
                      method="post" 
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="">
                                <textarea class="form-control txt_complaint" id="txt_complaint" 
                                          name="txt_complaint" rows="3" required="" readonly="" ></textarea>
                            </div>
                        </div>
                    </div>
