...
//                alert(dateEntered+"\n"+today);
                if (to.length > 0 && to.length != 0 && from.length > 0 && from.length != 0 && weight.length > 0 && weight.length != 0 && bookingDate.length > 0 && bookingDate.length != 0) {
                    if (dateEntered >= today) {
                        ...
                        $.ajax({
                            url: "../code/ajaxRequests.php?action=timeAndPrice",
                            type: 'POST',
                            dataType: 'JSON',
            ...
            function getFromAddressData(from) {
                ...
                $.ajax({
                    url: "../code/ajaxRequests.php?action=from",
                    type: 'POST',
//                    dataType: 'JSON',
                    data: {from: from},
                    beforeSend: function () {
...
//                alert(result);
            ...
            function getToAddressData(to) {
                ...
                $.ajax({
                    url: "../code/ajaxRequests.php?action=to",
                    type: 'POST',
//                    dataType: 'JSON',
                    data: {to: to},
                    beforeSend: function () {
...
//                        $(".handle-spinner").show();
            ...
            function getBookedCourierData() {
                $(document).on("click", ".data-edit", function () {
                    ...
                    $.ajax({
                        url: 'code/ajaxRequests.php?action=get-booked-courier-data',
                        method: 'POST',
            ...
            function deleteBookedCourierData(courierId) {
                ...
                if(res){
                    window.location.href = "code/ajaxRequests.php?action=delete-booked-courier-data&courierId="+courierId;
                }
            }
...
//                        echo '<pre>';print_r($pageLimit);
            ...
            $queryCount = "SELECT count(*) FROM tbl_courier_booking WHERE ysn_deleted=0 "
                    . "".(!empty($ysnApproved) ? 'AND ysn_approved = 0' : '');
...
<!--                                        <a 
                                        ...
                                        <a href="../user/track-courier.php?txt_tracking_id=<?=$rows['txt_tracking_id']?>"
                                           target="_blank"
                                           class="text-dark data-delete" 
                                           style="cursor: pointer;"
                                           title="Print PDF">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold" id="exampleModalLabel">Update & Approve Courier Package</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="code/ajaxRequests.php?action=updateCourierPackage" 
                      method="post" 
                    ...
                    <div class="row">
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            <input type="hidden" class="form-control" id="int_courier_booking_id" name="int_courier_booking_id" 
                                   aria-describedby="int_courier_booking_id" required="true" readonly="">
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <input type="number" class="form-control senderNumber" id="senderNumber" name="txt_sender_number" 
                                       value="<?= $_SESSION['number'] ?>" readonly=""
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <input type="number" class="form-control courierWeight" onclick="hideTable()" name="weight" id="courierWeight"
                                       placeholder="kgs" required=""  readonly="">
                            </div>
                        </div>
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <input type="number" class="form-control recipientAlternativeNumber" id="recipientAlternativeNumber" name="txt_recipient_alternate_number" 
                                       aria-describedby="txt_recipient_alternate_number"  readonly=""
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <input type="email" class="form-control recipientEmail" id="recipientEmail" name="txt_recipient_email" 
                                       aria-describedby="txt_recipient_email" placeholder="Recipient Email" readonly="">
                            </div>
                        </div>
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="">
                                <input type="text" class="form-control txt_service_type" id="serviceType" 
                                       name="txt_service_type" 
                                       aria-describedby="txt_recipient_address_line1_help" value=""
                                        readonly="" placeholder="H.N., Street" required="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-3 ">
                        <input type="submit" onclick="getTimeAndDate();hideTable();" 
                               class="btn btn-secondary mt-2 font-weight-bold" value="Submit" />
                        <br />
